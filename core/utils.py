...
# core/utils/translator.py
from deep_translator import GoogleTranslator
from django.utils.translation import gettext as _
from django.utils.translation import activate, get_language
import functools

def auto_translate(view_func):
    """
    Decorator to automatically translate view responses
    ...
    def wrapper(request, *args, **kwargs):
        ...
        lang = request.GET.get('lang', 
                              request.COOKIES.get('preferred_language', 
...
class TemplateTranslator:
    """Translate template variables on the fly"""
    ...
    def translate_text(self, text, target_lang='fr'):
        ...
        try:
            # Don't translate numbers, codes, or very short text
            if (text.isdigit() or 
                len(text.strip()) < 2 or 
                text.startswith('{') or 
                'SKU' in text or 
